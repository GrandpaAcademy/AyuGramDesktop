...
public:
	...
	[[nodiscard]] rpl::producer<> stealthForwardSelectionRequest() const {
		return _stealthForwardSelection.events();
	}
...
private:
	...
	object_ptr<Ui::RoundButton> _forward, _stealthForward, _sendNow, _delete, _messageShot;
	...
	rpl::event_stream<> _stealthForwardSelection;
